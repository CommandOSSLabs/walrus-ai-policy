  ...
  return (
    <Dialog>
      ...
      <DialogContent
        ...
        className="p-0 gap-0 bg-[#1A2130] border border-[#3B4A45] overflow-hidden w-130 flex flex-col"
        style={{
          maxWidth: "100%",
        }}
      >
        ...
        <Vstack className="px-6 py-4 gap-5">
          <Center className="bg-[#0D111D] border border-[#352F2F] rounded-lg px-4 py-3 gap-6">
            ...
            <Center className="bg-[#46F1CF]/10 border border-[#46F1CF]/20 rounded-sm px-3 h-full">
              <Typography font="jetbrains" className="text-[#46F1CF] text-2xs">
                v{artifact.version}
              </Typography>
            </Center>
          </Center>
            ...
            <div className="grid grid-cols-2 gap-3">
              {ListPlatform.map((meta) => (
                ...
                >
                  ...
                  <Vstack className="gap-0.5 text-xs items-start">
