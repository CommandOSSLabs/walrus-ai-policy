...
CREATE INDEX artifact_ai_meta_tags_gin ON artifact_ai_meta USING GIN(tags);
...
ALTER TABLE artifact_ai_meta ADD COLUMN search_vector TSVECTOR;
CREATE INDEX artifact_ai_meta_search_vector_gin ON artifact_ai_meta USING GIN(search_vector);
